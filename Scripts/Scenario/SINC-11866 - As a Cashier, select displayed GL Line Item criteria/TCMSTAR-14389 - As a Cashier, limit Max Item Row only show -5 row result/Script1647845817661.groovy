...
WebUI.setText(findTestObject('Sider/Sider Inc Payment Menu/Inc - MR - Mon GL Line Item/input Max Row Item'), '-5')

WebUI.delay(2)

WebUI.sendKeys(findTestObject('Sider/Sider Inc Payment Menu/Inc - MR - Mon GL Line Item/input Max Row Item'), '-')

WebUI.sendKeys(findTestObject('Sider/Sider Inc Payment Menu/Inc - MR - Mon GL Line Item/input Max Row Item'), '5')
...
if (!(result.equals(''))) {
    KeywordUtil.logInfo('Field input \'Max Row Item\' bisa diisi nilai negatif')

    KeywordUtil.markFailedAndStop('Field input \'Max Row Item\' bisa diisi nilai negatif')
} else {
    KeywordUtil.markPassed('Field tidak bisa diisi nilai negatif')
}

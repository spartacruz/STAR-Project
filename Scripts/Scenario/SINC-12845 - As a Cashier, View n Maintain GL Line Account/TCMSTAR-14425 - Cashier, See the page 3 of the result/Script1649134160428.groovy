...
WebUI.callTestCase(findTestCase('Scenario/SINC-12845 - As a Cashier, View n Maintain GL Line Account/mod/verify GL Line Data Result - Page Count Validation'), 
    [('nexpectedPage') : '3'], FailureHandling.STOP_ON_FAILURE)

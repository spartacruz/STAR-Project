...
def getStringValueFromObject(theObject) {
...
println(getStringValueFromObject(objNoPelanggan))
println(getStringValueFromObject(objNamaPelanggan))

println(getStringValueFromObject(objNoKuitansi))
println(getStringValueFromObject(objTglKuitansi))

println(getStringValueFromObject(objNoPosting))
println(getStringValueFromObject(objTglPosting))

println(getStringValueFromObject(objStatus))
println(getStringValueFromObject(objKodeKasBank))

println(getStringValueFromObject(objNoPostingBKU))
println(getStringValueFromObject(objNilai))
